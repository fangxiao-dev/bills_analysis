...
| TC-003 | upload后的解析进度实时显示，上传界面—每个item加入status状态 | PLANNED | 20260214-1725-02 | agent-a | 2026-02-14T17:50:09+01:00 | backend ready: consume inputs[].status/error; frontend UI wiring pending |
...
| TC-006 | merged结果在前端提供打开的链接，放在Submit旁边，等merged后开放下载按钮（要考虑上线后这个merged excel如何处理） | PLANNED | 20260214-1725-02 | agent-a | 2026-02-14T17:50:15+01:00 | backend ready: consume merge_output.output_path; frontend button wiring pending |
